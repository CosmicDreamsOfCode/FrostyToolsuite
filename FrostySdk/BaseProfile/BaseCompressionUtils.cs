...
namespace FrostySdk.BaseProfile
{
    public class BaseCompressionUtils : ICompressionUtils
    {
        public string GetOodleDllName(string basePath)
        {
            ...
            else if (ProfilesLibrary.IsLoaded(ProfileVersion.Fifa23, ProfileVersion.NeedForSpeedUnbound, ProfileVersion.Battlefield6))
            {
        ...
        public bool LoadOodle => ProfilesLibrary.IsLoaded(ProfileVersion.Fifa18, ProfileVersion.Fifa19, ProfileVersion.Anthem,
            ...
            ProfileVersion.Battlefield2042, ProfileVersion.Madden23, ProfileVersion.Fifa23, ProfileVersion.NeedForSpeedUnbound, ProfileVersion.Battlefield6);
